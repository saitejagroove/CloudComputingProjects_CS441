...
/**
 * Using 3 datacenters to simulate a Hybrid Cloud platform with Timesharing
 *
 */

object CsimAllHybrid {
  ...
  def main(args: Array[String]): Unit = {
    ...
    * Load general config options
    ...
    LOG.debug("N. Hosts: "+datacenters(2).getHostList.size())
  ...
  private def writeResultsToCSV(list: List[CustomCloudlet]) : Unit = {
    ...
    val csvWriter = new FileWriter("simulation1.csv")
