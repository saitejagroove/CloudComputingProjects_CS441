 ...
 * - createCloudletImpl(userId: Int, num: Int, cloudletType: CustomCloudlet.Type, startId: Int, cloudletList: scala.collection.mutable.ListBuffer[CustomCloudlet]):Unit
 * - createCloudlet(userId: Int, cloudlets: Int, cloudletType: CustomCloudlet.Type) : List[CustomCloudlet]
 * - printSingleResultLine(cloudlet: Cloudlet): Unit
 * - printCloudletList(list: List[CustomCloudlet]): Unit
 *
 */
...
object CsimNoSpace {
  ...
  def main(args: Array[String]): Unit = {
    ...
    * Please see createCloudlet method for additional info.
     ...
     * Please see StandardPolicyBroker.processEvent for additional info.
     */
  ...
  def createHostImpl(num: Int, startId: Int, hostList: scala.collection.mutable.ListBuffer[Host]) : Unit = {
    ...
    * Please see related extended class (CustomHost.java and override method in StandardPolicyBroker.java)
     */
  ...
  /**
   * This method initializes an instance of StandardPolicyBroker.
   * @return
   */
  def createBroker() : StandardPolicyBroker = {
    val broker = new StandardPolicyBroker("Broker")
    return broker
  }
  ...
  private def writeResultsToCSV(list: List[CustomCloudlet]) : Unit = {
    ...
    val csvWriter = new FileWriter("NoSpaceShared.csv")
